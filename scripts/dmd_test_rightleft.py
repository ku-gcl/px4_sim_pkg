...
rospy.sleep(5)
mav.set_heading(0)
x, y, z = trajectory.rightleft(time_sec=0, amplitude=amp, altitude=altitude, w=w)
...
while (not rospy.is_shutdown() 
    ...
    x, y, z = trajectory.rightleft(time_sec=time_sec, amplitude=amp, altitude=altitude, w=w)
