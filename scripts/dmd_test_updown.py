...
rospy.sleep(5)
mav.set_heading(0)
x, y, z = trajectory.updown(time_sec=0, amplitude=amp, base_altitude=altitude, w=w)
...
while (not rospy.is_shutdown() 
    ...
    x, y, z = trajectory.updown(time_sec=time_sec, amplitude=amp, base_altitude=altitude, w=w)
