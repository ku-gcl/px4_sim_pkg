...
rospy.sleep(2.0)
x, y, z = trajectory.updown(time_sec=0, amplitude=amplitude, base_altitude=base_altitude, w=w)
mav.set_destination(x, y, z)
# mav.set_local_position(x, y, z)
mav.pub_local_position()
rospy.sleep(2.0)
...
while (not rospy.is_shutdown() 
    ...
    x, y, z = trajectory.updown(time_sec=time_sec, amplitude=amplitude, base_altitude=base_altitude, w=w)
    mav.set_destination(x, y, z)
    # mav.set_local_position(x=x, y=y, z=z)
    mav.pub_local_position()
